  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-body tracking-wider uppercase",
  {
    variants: {
      variant: {
        ...
        gold: "bg-primary text-primary-foreground hover:shadow-[0_4px_30px_hsl(43_74%_49%/0.3)] hover:scale-105 rounded-sm",
        goldOutline: "border-2 border-primary text-primary bg-transparent hover:bg-primary hover:text-primary-foreground hover:shadow-[0_4px_30px_hsl(43_74%_49%/0.3)] rounded-sm",
        elegant: "bg-transparent border border-foreground/30 text-foreground hover:border-primary hover:text-primary hover:shadow-[0_4px_30px_hsl(43_74%_49%/0.15)] rounded-sm",
      },
      size: {
